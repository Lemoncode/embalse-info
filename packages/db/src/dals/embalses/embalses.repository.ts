...
import { mapperFromCuencasMediterraneaToArcgis, mapperFromCuencasCatalanaToArcgis } from "./embalses.mappers.js";
...
export const embalsesRepository = {
  ...
  actualizarCuencaMediterranea: async (): Promise<boolean> => {
    ...
    console.log(
      `Se han scrapeado ${embalsesMediterranea.length} embalses de la Cuenca Mediterranea`
    );
